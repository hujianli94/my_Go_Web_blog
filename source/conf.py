...
project = u'小健_Go_Web开发实战学习'
copyright = u'2021, huxiaojian'
...
htmlhelp_basename = '小健Go Web开发实战学习'
html_logo = '_templates/goweb.png'
...
latex_documents = [
    (master_doc, '小健Go Web开发实战学习.tex', u'小健Go Web开发实战学习 Documentation',
